        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="relative hidden md:block w-48 xl:w-64">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-xs rounded-xl bg-black/20 dark:bg-black/30 border border-white/15 text-white placeholder:text-slate-300 focus:outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-500/30 backdrop-blur-md transition-all"
            />
          </div>
